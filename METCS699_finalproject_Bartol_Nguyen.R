...
set.seed(31)
outer.split <- initial_split(splitting.df, prop = 0.66, strata = Class)
...
pc <- prcomp(training[, -ncol(training)] %>% 
...
balancing.df <- Project_Data_Cleansed2
